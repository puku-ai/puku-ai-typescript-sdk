...
async function main() {
  console.log('Puku AI with Web Search (Streaming)');
  console.log('==================================');
  ...
  const stream = client.messages
    .stream({
      ...
      messages: [
        {
          role: 'user',
          content: "fetch https://poridhi.io/ and summarize the content. Please use web search to gather any additional information if needed.",
        },
      ],
      tools: [
        {
